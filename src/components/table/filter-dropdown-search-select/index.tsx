...
type Props<TOption extends DefaultOptionType = DefaultOptionType> = {
...
export const FilterDropdownSearchSelect = forwardRef(
  <TOption extends DefaultOptionType = DefaultOptionType>(
    ...
    const { setSelectedKeys, selectedKeys, clearFilters, confirm, options, visible } = props
    ...
    return (
      <div style={{ padding: 8 }} onKeyDown={(e) => e.stopPropagation()}>
        ...
        <Row justify={"space-between"}>
          ...
          <Button type="primary" onClick={() => handleSearch()} icon={<FilterFilled />} size="small">
            Filter
          </Button>
        </Row>
      </div>
