...
const accessControlProviderFactory = (service: ApiClient): AccessControlProvider => ({
  can: async ({ resource, action, params }) => {
    try {
      ...
      const resp = await service.instance
        .get<CheckPermissionResponse>("permissions/check", {
