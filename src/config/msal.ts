...
import type { AuthenticationResult } from "@azure/msal-browser/src/response/AuthenticationResult"

// Environment variables for Azure AD configuration
const { VITE_AUTH_AZURE_CLIENT_ID, VITE_AUTH_AZURE_AUTHORITY, VITE_AUTH_AZURE_SCOPE } = import.meta.env
